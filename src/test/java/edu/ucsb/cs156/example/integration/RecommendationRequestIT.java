...
public class RecommendationRequestIT {
  ...
  public void an_admin_user_can_post_a_new_recommendationRequest() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/recommendationrequests/post?requesterEmail=a@ucsb.edu&professorEmail=b@ucsb.edu&explanation=PhD&dateRequested=2026-01-03T00:00:00&dateNeeded=2026-06-01T00:00:00&done=true")
                    .with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
