  ...
  public void an_admin_user_can_post_a_new_menu_item_review() throws Exception {
    ...
    MenuItemReview review1 =
        MenuItemReview.builder()
            ...
            .stars(5)
            .dateReviewed(LocalDateTime.parse("2023-06-15T12:00:00"))
            .comments("Excellent!")
            .build();
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/menuitemreview/post?itemId=7&reviewerEmail=admin@example.com&stars=5&comments=Excellent!&dateReviewed=2023-06-15T12:00:00")
                    .with(csrf()))
