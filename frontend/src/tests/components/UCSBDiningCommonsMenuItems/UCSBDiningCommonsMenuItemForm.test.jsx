...
describe("UCSBDiningCommonsMenuItemForm tests", () => {
  ...
  test.each(["portola", "ortega", "carillo", "dlg"])(
    ...
    async (code) => {
      ...
      fireEvent.change(
        screen.getByTestId("UCSBDiningCommonsMenuItem-station"),
        { target: { value: "entrees" } },
      );
      fireEvent.change(screen.getByTestId("UCSBDiningCommonsMenuItem-name"), {
        target: { value: "Dish" },
      });
