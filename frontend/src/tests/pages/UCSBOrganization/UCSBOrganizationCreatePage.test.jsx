...
describe("UCSBOrganizationCreatePage tests", () => {
  ...
  test("renders without crashing", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByLabelText("Org Translation Short"),
      ).toBeInTheDocument();
    });
    await waitFor(() => {
      expect(screen.getByLabelText("Org Translation")).toBeInTheDocument();
    });
    await waitFor(() => {
  ...
  test("on submit, makes request to backend, and redirects to /ucsborganization", async () => {
    ...
    expect(mockToast).toBeCalledWith(
      "New UCSBOrganization Created - orgCode: SKY orgTranslation: Skydiving Club at UCSB",
    );
