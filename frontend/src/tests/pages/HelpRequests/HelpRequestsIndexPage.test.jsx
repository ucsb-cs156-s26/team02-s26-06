...
describe("HelpRequestsIndexPage tests", () => {
  ...
  test("renders three Help Requests correctly for regular user", async () => {
    ...
    const requesterEmailInput = screen.queryByText("Requester Email");
    expect(requesterEmailInput).toBeInTheDocument();

    const teamIdInput = screen.queryByText("TeamId");
    expect(teamIdInput).toBeInTheDocument();

    const tableOrBreakoutRoomInput = screen.queryByText(
      "Table or Breakout Room",
    );
    expect(tableOrBreakoutRoomInput).toBeInTheDocument();

    const requestTimeInput = screen.queryByText("Request Time (iso format)");
    expect(requestTimeInput).toBeInTheDocument();

    const explanationInput = screen.queryByText("Explanation");
    expect(explanationInput).toBeInTheDocument();

    const solvedInput = screen.queryByText("Solved");
